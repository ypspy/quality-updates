...
| 문서 | 용도 |
|------|------|
| [quarterly-operations-guide.md](quarterly-operations-guide.md) | **분기 파이프라인** — Agent/HITL 역할, Phase 1~5, 품질 게이트 |
| [editor-curation-workflow.md](../editor-curation-workflow.md) | **편집기** — 마커, skip, prepare_deploy |

README·CONTRIBUTING의 워크플로 요약은 위 두 문서를 정본으로 한다.
...
| 주제 | 정본 |
|------|------|
| 분기 운영 | `quarterly-operations-guide.md` |
| 편집기 | `editor-curation-workflow.md` |
