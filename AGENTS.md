...
- **분기 요약 포맷**: `quality-updates-writer` 스킬 없이 Executive Summary·note 블록 형식을 임의로 바꾸지 않는다.
...
- **Gold standard** (요약 시): `docs/quality-updates/2024/2024-10-01_to_2024-12-31.md`, `docs/quality-updates/2025/2025-10-01_to_2025-12-31.md`
