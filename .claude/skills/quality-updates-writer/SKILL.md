...
- **Phase 2 집계 요약(Executive Summary·기관별 요약·시사점)은 생성하지 않음** — SUMMARIZE는 Phase 1 링크 note만 추가.
...
**참고 템플릿**: `docs/quality-updates/2023/2023-04-01_to_2023-06-30.md` 참조.
...
| 상황 | 문법 |
|------|------|
| 모든 링크 요약 (일반·긴 요약·Type A·Type B) | `!!! note "…"` (title만 유형별 상이) |
| Appendix·부가 목록 (REFERENCE G·E) | `??? info "…"` |
...
- [ ] 요약 블록 내 URL 없음
- [ ] 모든 note는 `!!! note` (Appendix·중첩 `??? info`는 REFERENCE E·G)
- [ ] 접두어 스타일 블록 내 일관 (스타일 A/B 혼용 없음)
- [ ] 어미 규칙 준수 (Phase 1: 명사형/~함/~임)
- [ ] 수치·날짜·기준치 원문 보존
...
> 패턴 예시는 `reference/gold-excerpts.md` 우선. 전문 gold(`2023-04-01_to_2023-06-30.md`, `2025-10-01_to_2025-12-31.md`)는 선택 참고.
